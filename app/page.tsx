      ...
      <main className="flex justify-center ">
        <section className="relative z-30! w-full max-w-360! lg:max-w-237.5! xl:max-w-360! mx-auto px-8 flex flex-col items-center! justify-evenly">
            ...
            <div className="relative w-full sm:h-auto lg:h-[150vh] xl:-mt-80 mt-10">
              ...
              >
                <div className="flex flex-col gap-[30px] items-center xl:items-start">
                  ...
                  <h4 className="text-[#F8F7FC] font-Satoshi text-[22px] md:text-[22px] font-normal leading-[140%] text-center xl:text-start">
          ...
          >
            ...
            <motion.div
              className="relative z-10 flex min-h-screen w-full xl:items-center items-start justify-center px-5 py-61.25"
              initial={{ opacity: 0 }}
        ...
        <div className="">
          ...
          <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="relative z-20 flex justify-between items-center w-full h-auto">
